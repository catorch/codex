...
- Branch: `restore-js-repl-rust-v0.134.0`
- Base tag: `rust-v0.134.0`
- Restore commit: `e3f69f2a49 Restore js_repl support`
...
6. Validate the stable restore.
   ...
   cargo test -p codex-core --lib js_repl -- --nocapture
   cargo test -p codex-features js_repl -- --nocapture
